<template>
  <div class="app-container">
    ...
    <el-dialog v-model="detailOpen" title="司法取证员详情" width="720px" append-to-body class="kmc-user-detail-dialog">
...
<script setup name="KmcJudgeAdmin" lang="ts">
...
function resetQuery() {
  ...
  queryParams.value.roleId = KMC_JUDGE_ROLE_ID;
  handleQuery();
}
...
function handleUpdate(row: any) {
  ...
  getUser(userId).then((response) => {
    ...
    form.value.postIds = [];
    form.value.roleIds = [KMC_JUDGE_ROLE_ID];
