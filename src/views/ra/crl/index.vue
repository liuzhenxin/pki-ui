  ...
  <div class="p-2">
    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Stamp" @click="handleIssue" v-hasPermi="['ra:crl']">签发CRL</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['ra:crl']">删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Upload" @click="handleImport" v-hasPermi="['ra:crl']">导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="info" plain icon="Download" @click="handleExport" v-hasPermi="['ra:crl']">导出查询</el-button>
          </el-col>
      ...
      <el-table v-loading="loading" border :data="crlList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" fixed="right" width="190" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-button link type="primary" icon="View" @click="handleDetail(scope.row)" v-hasPermi="['ra:crl']">详情</el-button>
            <el-button link type="success" icon="Promotion" @click="handlePublish(scope.row)" v-hasPermi="['ra:crl']">发布</el-button>
            <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ra:crl']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
